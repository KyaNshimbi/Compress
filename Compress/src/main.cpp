...
public:
	PNGCompress()
		: rowPointers{ nullptr }, width{ 0 }, height{ 0 }, colorType{ 0 }, bitDepth{ 0 }, readingFPtr{ nullptr }, readingStruct{ nullptr }, readingInfoPtr{ nullptr } {}
	...
	{
		fopen_s(&readingFPtr, fileName, "rb");
		if (!readingFPtr)
		{
			return false;
		}
